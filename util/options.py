...
def parse_custom_options():
    ...
    parser.add_argument('--version', type=str, default='original', required=True, help='original, kmeans, decv1, decv2, decv3, decv4, decv5, decv6, ShapeAppV1DV1, ShapeAppV2DV1, ShapeAppV1DV2, ShapeAppV2DV2')
